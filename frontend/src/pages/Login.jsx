      ...
      <div className="relative z-10 w-full max-w-md px-6 animate-in fade-in slide-in-from-bottom-8 duration-700">
        <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/20 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-primary-800 to-accent-600 px-8 py-10 text-center relative overflow-hidden">
            ...
            <h1 className="text-4xl font-bold text-white tracking-tight relative z-10 drop-shadow-sm">DocFlow</h1>
            <p className="text-primary-100 mt-2 text-sm font-medium relative z-10 tracking-wide">
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                disabled={isLoading}
                className={clsx(
                  "w-full flex items-center justify-center space-x-2 py-3.5 px-4 border border-transparent rounded-xl shadow-md text-sm font-bold text-white bg-primary-800 hover:bg-primary-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-800 transition-all mt-6",
