      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        {loading ? (
          ...
          <div className="p-16 text-center">
            ...
            <p className="text-gray-500 mt-2">There are no pending requests for you to review at this time.</p>
          </div>
        ) : (
                ...
                {requests.map(req => (
                  <tr key={req.id} className="hover:bg-gray-50/50">
                    <td className="px-6 py-4">
                      ...
                      <div className="text-xs text-gray-500">{req.student.rollNumber} • {req.student.year} Year • {req.student.batch} Batch</div>
                    </td>
